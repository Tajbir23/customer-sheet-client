...
const GptAccounts = () => {
            ...
            {p === '...' ? (
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: currentPage === p ? '0 4px 15px rgba(139, 92, 246, 0.4)' : undefined,
                }}
              >
                {p}
              </button>
  ...
  return (
    <div className="min-h-screen p-6 md:p-8 lg:p-10 max-w-7xl mx-auto">
      <Helmet>
        <title>GPT Accounts - Customer Sheet</title>
      </Helmet>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[var(--text-tertiary)] mt-1">Manage and monitor all GPT accounts</p>
            </div>
          </div>
          <button
      ...
      {!isLoading && data?.length > 0 && (
        <div
          className="rounded-xl p-4 mb-8 animate-fade-in flex flex-wrap items-center justify-between gap-4 border"
          style={{
            background: 'var(--bg-surface)',
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
              {data.map((account, index) => (
                <GptAccountCard key={account._id} account={account} index={index} />
              ))}
            </div>
